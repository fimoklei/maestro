...
| View options | **Filter** / **Display** | The two icon-only controls in the Inventory's band 2 beside **Re-read Inventory**. **Filter** narrows by type and status and carries the count of active filters; **Display** switches columns off and on. |
