...
| Register a consuming repo | **Register repository** | The one control that registers a repository, in band 1 of **Repositories**. It replaces the sidebar's *+ repo*, which is retired (#991). |
