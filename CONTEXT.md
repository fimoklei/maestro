...
| Target roll-up | **In sync** | A whole target's Status on **Deploy-state**. A single skill is **Up to date**, never *in sync*; a skill row in the target's pane carries one mark, first match wins: **Local edits**, **Unverified**, **No longer released**, **Behind**, **Up to date** (#993). |
