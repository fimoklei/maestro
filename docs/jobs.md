...
| Update every behind target in one action · [#833](https://github.com/fimoklei/maestro/issues/833) | B, A | *When* several targets lag the central inventory, *I want to* bring them all current in one action, *so I can* stay up to date without going target by target. |
