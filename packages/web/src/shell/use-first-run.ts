...
// sidebar's inert rendering, and the connect gate all key off this instead of each
...
// steer a configured user *away* from the connect gate on a direct/deep-link visit
// (not just away from the "not configured" dead-end) — "the connect gate never
